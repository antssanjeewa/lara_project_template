...
export const get_item_list = ({ commit },item) => {
    return new Promise((resolve, reject) => {
        axios.get(`api/permissions?page=${item.page}`,{params:{search:item.query}}).then(response => {
...
export const add_new_item = ({ dispatch },item) => {
    return new Promise((resolve, reject) => {
        axios.post('api/permissions',item).then(response => {
...
export const delete_given_item = ({ commit },id) => {
    return new Promise((resolve, reject) => {
        axios.delete(`api/permissions/${id}`).then(response => {
            resolve(response.data);
        }, error => {
            reject(error);
        })
