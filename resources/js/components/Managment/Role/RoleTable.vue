...
<template>
  <v-card>
    ...
    <--=============================================================================================-->
    <table-toolbar title="Roles Data Table" :total="noData" :add="setToggleDialog">
      <v-flex xs4>
        <v-text-field
          v-model="search"
          append-icon="search"
